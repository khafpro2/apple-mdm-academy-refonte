...
const icons: Record<LogoName, (size: number) => React.ReactNode> = {
  apple: (size) => (
    <Svg size={size}>
      <path
        d="M7 4.5h8a3 3 0 013 3v9a3 3 0 01-3 3H7a3 3 0 01-3-3v-9a3 3 0 013-3z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.75"
      ...
      />
      <path
        d="M14.5 11.5l3-1.1 3 1.1v2.4c0 2.2-1.3 3.9-3 4.6-1.7-.7-3-2.4-3-4.6v-2.4z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
