...
export const sidebarMainNav: SidebarNavItem[] = [
  ...
  { label: "Cours", href: "/cours", icon: "resource" },
  {
    ...
    icon: "apple",
    children: [
      { label: "Apple Fundamentals", href: "/parcours/apple-fundamentals", icon: "apple" },
      { label: "Apple Device Support", href: "/parcours/apple-device-support", icon: "apple" },
      { label: "Apple Deployment", href: "/parcours/apple-it-professional", icon: "apple" },
      { label: "Apple Security", href: "/parcours/apple-enterprise-expert", icon: "shield" },
      { label: "Apple Enterprise", href: "/parcours/apple-enterprise-architect", icon: "apple" },
      ...
      { label: "Intune Apple Advanced", href: "/parcours/intune-apple-advanced", icon: "intune" },
    ],
  },
  {
