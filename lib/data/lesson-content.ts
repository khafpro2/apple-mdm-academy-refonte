...
const LESSON_TOPICS: Record<string, LessonTopic> = {
  ...
  "services-entreprise": {
    ...
    outcomes: [
      ...
      "Relier chaque service au cycle de vie appareil.",
      "Préparer une architecture Apple enterprise cohérente.",
    ],
    concepts: [
      "Apple Business Manager centralise organisations, rôles, achats, serveurs MDM et identifiants gérés.",
      "ADE automatise l'enrôlement et réduit les manipulations lors du premier démarrage.",
      "Apps & Books permet d'acheter et d'attribuer des licences applicatives sans compte personnel.",
    ],
    actions: [
      "Vérifier que les achats Apple sont rattachés à ABM.",
      "Créer les rôles admin minimaux nécessaires.",
      "Relier ABM au MDM puis tester un appareil neuf ou effacé.",
    ],
    validation: [
      "Un appareil acheté arrive automatiquement dans ABM puis dans le MDM.",
      "Les licences d'apps sont visibles et assignables.",
    ],
    risks: [
      "Multiplier les comptes admin globaux.",
      "Acheter du matériel hors canaux reliés à ABM.",
    ],
  },
  "diagnostic-systeme": {
