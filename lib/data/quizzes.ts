...
export const rawQuizzesBeforePrepare: Quiz[] = [
  ...
  },
  {
    ...
    type: "examen",
    description:
      "Préparation Apple Device Support — banque issue des pistes audio et du parcours support, cible officielle 80 questions.",
    duration: "120 min",
    durationMinutes: 120,
    passingScore: 75,
    examMode: true,
    examQuestionCount: 80,
    questions: examPools["examen-apple-device-support"].slice(0, 5),
  },
  {
  ...
  },
  {
    ...
    type: "examen",
    description:
      "Simulation Jamf Pro Associate : 50 questions aléatoires inspirées des domaines Jamf 100, sans copie du contenu officiel.",
    duration: "60 min",
    durationMinutes: 60,
    passingScore: 80,
    examMode: true,
  ...
  },
  {
    ...
    type: "examen",
    description:
      "Simulation interne Intune Apple : 60 questions (ABM, ADE, APNs, compliance, Platform SSO) — ce n'est pas un titre Microsoft.",
    duration: "120 min",
    durationMinutes: 120,
    passingScore: 80,
    examMode: true,
  ...
  },
  {
    ...
    type: "examen",
    description:
      "Simulation interne avancée Intune Apple : 60 questions (Conditional Access, Defender, SCEP, VPN, Platform SSO).",
    duration: "120 min",
    durationMinutes: 120,
    passingScore: 80,
    examMode: true,
